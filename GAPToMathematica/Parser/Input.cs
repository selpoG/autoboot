...
namespace Sprache
{
	...
	{
		public IDictionary<object, object> Memos { get; } = new Dictionary<object, object>();
		...
		public bool Equals(IInput other) => other is null
				? false
				: ReferenceEquals(this, other) ? true : string.Equals(Source, other.Source) && Position == other.Position;
